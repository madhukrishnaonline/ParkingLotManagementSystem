...
const routes: Routes = [
    ...
    { path: 'pay/:ticketId', component: PaymentComponent, canActivate: [AppRouteSecurityGuard] },
    { path: 'ticket/:ticketId', component: TicketDetailsComponent, canActivate: [AppRouteSecurityGuard] },
